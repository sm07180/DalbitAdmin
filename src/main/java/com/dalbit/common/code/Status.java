...
public enum Status {
    ...
    //배너아이템 조회
    배너아이템조회_데이터없음("0", "no.data", "배너아이템 조회 데이터가 없을 시"),
    배너아이템조회_성공("C001", "select.success", "배너아이템 조회 성공 시"),
    배너아이템조회_에러("C006", "server.error", "배너아이템 조회에서 에러 발생 시"),
    //배너아이템 상세조회
    배너아이템상세조회_성공("0", "select.success", "배너아이템 상세조회 성공 시"),
    배너아이템상세조회_상품코드없음("-1", "no.data", "배너아이템 상세조회에서 상품코드가 없을 시"),
    배너아이템상세조회_에러("C006", "server.error", "배너아이템 상세조회에서 에러 발생 시"),
    //배너아이템 등록
    배너아이템등록_성공("0","insert.success", "배너아이템등록 성공 시"),
    배너아이템등록_실패("C006", "server.error", "배너아이템등록 실패 시"),
    //배너아이템 수정
    배너아이템수정_성공("0", "update.success", "배너아이템수정 성공 시"),
    배너아이템수정_실패("-1", "no.data", "배너아이템수정에서 배너아이템번호가 없을 시"),
    배너아이템수정_에러("C006", "server.error", "배너아이템수정에서 에러 발생 시"),
    //배너아이템 삭제
    배너아이템삭제_성공("0", "delete.success", "배너아이템삭제 성공 시"),
    배너아이템삭제_실패("-1", "no.data", "배너아이템삭제에서 배너아이템번호가 없을 시"),
