...
public enum Status {
    ...
    교환아이템등록_플랫폼미선택("-1","not.selected.platform", "교환아이템등록에서 선택된 플랫폼이 없을 시"),
    교환아이템등록_IOS미지원("-2","ios.not.supported", "교환아이템등록에서 IOS는 미지원."),
    ...
    교환아이템수정_플랫폼미선택("-2","not.selected.platform", "교환아이템수정에서 선택된 플랫폼이 없을 시"),
    교환아이템수정_IOS미지원("-3","ios.not.supported", "교환아이템수정에서 IOS는 미지원."),
