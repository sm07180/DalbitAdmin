...
import com.dalbit.payment.vo.Pay_PayAddVo;
...
public class Pay_PayRestController {
     ...
     */
    @PostMapping("add")
    public String add(Pay_PayAddVo pay_PayAddVo, HttpServletRequest request) throws ParseException {
        String result = payPayService.payAdd(pay_PayAddVo, request);
        return result;
    }
