...
var banner_bannerType = [
  ...
  , new COMMON_CODE('rank', '17', '랭킹 Center')
  , new COMMON_CODE('My', '18', 'My Center')
];
...
var game_history_sort = [
  ...
  , new COMMON_CODE('1', '1', '최근 방송 시작 순으로')
  , new COMMON_CODE('2', '2', '게임진행횟수 순으로')
]
...
const event_draw_filter = [
  new COMMON_CODE('1', '0', '전체')
  , new COMMON_CODE('2', '1', '달')
  , new COMMON_CODE('3', '2', '기프티콘')
