var memberDataTableSource = {
    ...
    'broadHistory': {
        ...
        , 'columns': [
            {'title': 'key', 'data': 'roomNo'},
            {'title': 'NO', 'data': 'index@index'},
    ...
    'listenHistory': {
        ...
        , 'columns': [
            ...
            {
                'title': '청취방송제목',
                'data': '<a href="javascript//" onclick="javascript	Listen(this.id);" id="dataListen_roomNo "data-roomno="roomNo">title</a>'
            },
    ...
    'platformHistory': {
        ...
        , 'columns': [
            ...
            {'title': 'Browser', 'data': ''},
            {'title': 'Device', 'data': ''},
            {'title': 'MobileDeviceID', 'data': ''},
            {'title': 'MobileADID', 'data': ''},
            {'title': 'IP주소', 'data': ''}
        ]
        , 'title': '회원 접속 기록'
    ...
    'myStarHistory': {
        ...
        , 'columns': [
            {'title': 'key', 'data': 'memNo'},
            {'title': 'NO', 'data': 'index@index'},
            {
                'title': 'MyStarID',
                'data': '<a href="javascript//" onclick="javascript	MyStar(this.id);" id="dataMyStart_memNo "data-memno="memNo">memId</a>'
            },
    ...
    'myFanHistory': {
        ...
        , 'columns': [
            ...
            {
                'title': 'FanID',
                'data': '<a href="javascript//" onclick="javascript	Fan(this.id);" id="dataFan_memNo "data-memno="memNo">memId</a>'
            },
    ...
    'noticeHistory': {
        ...
        , 'columns': [
            ...
            {
                'title': '방송제목',
                'data': '<a href="javascript//" onclick="javascript	Notice(this.id);" id="dataNotice_roomNo "data-roomno="roomNo">title</a>'
            },
    ...
    'reportHistory': {
        ...
        , 'columns': [
            ...
            {
                'title': '신고내용',
                'data': '<a href="javascript//" onclick="javascript	Report(this.id);" id="dataReport_index@index "data-index="idx" data-id="reportId "data-report="reportMemId">etc</a>'
            },
    ...
    'responseHistory': {
        ...
        , 'columns': [
            ...
            {'title': '문의구분', 'data': ''},
            {'title': '문의UserID', 'data': ''},
            {'title': '문의대상UserID', 'data': ''},
            {'title': '문의 제목', 'data': ''},
            {'title': '접수일시/처리일시', 'data': ''},
            {'title': '첨부파일', 'data': ''},
            {'title': '처리상태', 'data': ''},
            {'title': '처리자', 'data': ''}
        ]
