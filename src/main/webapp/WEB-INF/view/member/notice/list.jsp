...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <!-- DATA TABLE END -->
            <div class="row col-lg-12 form-inline" style="padding-top: 2px;">
                <label class="text_center text_middle" style="font-weight: bold;font-size: 13px;color: #ffffff;background: #3e3e3e;width: 70px;height: 27px"> 개별/방송 중 공지</label>
                <label class="text_middle" style="font-size: 11px;height: 27px">ㆍ각 회원의 방송중 공지와 팬보드 내 연동된 공지 및 팬보드에서의 개인공지를 확인하고, 관리할 수 있습니다.</label>
                <hr style="border:solid 1px ;margin-top: 0px;margin-bottom: 3px;color: #0d6aad">
            </div>
            <!-- DATA TABLE -->
            <div class="row col-lg-12 form-inline">
...
<script>
    ...
    function getMemNo_info(id){
        ...
        // obj.mem_no = id;
        tmp_memNo = id;
        table_col_set(tmp_memNo,"myNoticeHistory");
    }
