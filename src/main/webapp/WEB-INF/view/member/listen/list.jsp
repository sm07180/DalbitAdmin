...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <!-- DATA TABLE END -->
            <div class="row col-lg-12 form-inline" style="padding-top: 2px;">
                <label class="text_center text_middle" id="detail_broad" style="font-weight: bold;font-size: 13px;width: 70px;height: 27px"> 방송기록</label>
                ...
                <label class="text_center text_middle" id="detail_listen" style="font-weight: bold;font-size: 13px;color: #ffffff;background: #3e3e3e;width: 70px;height: 27px"> 청취기록 </label>
