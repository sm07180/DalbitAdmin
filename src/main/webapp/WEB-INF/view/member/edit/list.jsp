    ...
    <div class="widget widget-table" id="main_table">
        <div class="widget-content">
            <div class="pull-right pt5" style="display: none;">
                ...
                <button type="button" class="btn btn-success" id="bt_editSearch">검색</button>
            </div>
...
<script>
    ...
    $("#editHistory").find("#searchText").keydown(function() {
        if (event.keyCode === 13) {
            $("#editHistory").find("#bt_editSearch").click();
        };
    });

    $("#editHistory").find("#bt_editSearch").on("click", function(){
