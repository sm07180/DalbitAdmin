...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <!-- DATA TABLE END -->
            <div class="row col-lg-12 form-inline" style="padding-top: 2px;">
                <label class="text_center text_middle" style="font-weight: bold;font-size: 13px;color: #ffffff;background: #3e3e3e;width: 70px;height: 27px"> MyStar</label>
                <label class="text_middle" style="font-size: 11px;height: 27px">ㆍ선택한 회원이 Fan으로 등록한 DJ회원이 MY스타 DJ가 됩니다.<br /> ㆍ마이스타 회원리스트를 확인하고 등록/삭제 할 수 있습니다.</label>
                <hr style="border:solid 1px ;margin-top: 0px;margin-bottom: 3px;color: #0d6aad">
            </div>
            <!-- DATA TABLE -->
            <div class="row col-lg-12 form-inline">
