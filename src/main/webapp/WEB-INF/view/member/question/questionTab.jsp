...
<div class="row col-lg-12 form-inline" style="padding-top: 2px; padding-bottom: 0px;">
    <div class="widget-content">
        <ul class="nav nav-tabs nav-tabs-custom-colored" role="tablist">
            <li class="active"><a href="#aaa" role="tab" data-toggle="tab"> 1:1문의 </a></li> <%-- href 수정 --%>
            <li><a href="#call" role="tab" data-toggle="tab"> 전화문의 </a></li>
            <li><a href="#mail" role="tab" data-toggle="tab"> 메일문의 </a></li>
         </ul>
        <div class="tab-content">
            <div class="tab-pane fade in active" id="aaa"><jsp:include page="../../customer/question/one.jsp"/></div> <%-- 1:1문의 --%>
