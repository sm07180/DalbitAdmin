        ...
        <div class="row col-lg-12 form-inline mt5" id="tabList_top">
            <div class="widget-content">
                <ul class="nav nav-tabs nav-tabs-custom-colored" role="tablist" id="tablist_con">
                    ...
                    <li><a href="#guestDetail" role="tab" data-toggle="tab" id="tab_guestDetail" onclick="getBroadHistory_guest(this.id);" class="hide">게스트관리</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="guestDetail"><jsp:include page="../guest/list.jsp"/></div>             <!-- 청취자 -->
