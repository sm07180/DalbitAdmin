...
<div class="player">
    ...
    <div>
        ...
        <p>
            <input type="text" class="form-control" value="" id="sdpURL" placeholder="wowza URL" style="display: none">
            <input type="text" class="form-control" value="edge" id="applicationName" placeholder="edge or origin" style="display: none">
            <input type="text" class="form-control" value="" id="streamName" placeholder="streamName" style="display: none">
        </p>
        <p>
