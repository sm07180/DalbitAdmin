...
<script type="text/javascript">
    ...
    function info_sel_success(dst_id, response, param) {
        ...
        if(response.data.guestState == "NO")
            ...
            response.data["icon_guestState"] = '<i class="fa fa-user" style="color: #a037d9;font-size:20px;"></i> ' + response.data.guestState + " / " + util.memNoLink(response.data.guest_userId + "( " + /*guest_nickName*/ + "닉네임 )", response.data.guest_mem_no);
