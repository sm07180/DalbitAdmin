            ...
            <div class="widget widget-table">
                <div class="col-md-12">
                    ...
                    <label id="liveTitle">
                        ...
                        &nbsp&nbsp&nbsp: 받은별(부스터 제외) 1점 + 누적청취자 2점 + 좋아요(부스터 제외) 1점 + 부스터(만료) 20점 + 부스터(진행) 30점 + 신규 팬(방송방 등록) 50점 <br/>
                        &nbsp※ 스페셜DJ 부스터 효과, 무료 부스터는 부스터 0건(진행중 1건)으로 표기 및 좋아요 10개 비누적 되며 10점이 추가됩니다.
                    </label>
                    <br/>
