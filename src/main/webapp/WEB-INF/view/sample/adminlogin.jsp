...
<script type="text/javascript">
    ...
    function menu(){
        var data = new Object();
        //data.url = "http://admin.inforex.co.kr/dalbit/getCommonMenu.php";

        var option = {
            type : 'GET'
            , dataType : 'json'
        };
        util.getAjaxData("menu", "http://admin.inforex.co.kr/dalbit/getCommonMenu.php", null, menuSuccess, menuFail, option);
    }
    ...
    function callmanu(){
        document.getElementById("inforexMenu").src = "http://admin.inforex.co.kr/dalbit/getCommonMenu.php";
    }
    function menu2(){
