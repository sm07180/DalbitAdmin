            ...
            <%--<div class="row col-lg-12 form-inline">--%>
                <%--<div class="widget widget-table">--%>
                    <%--<div class="widget-content">--%>
                        ...
                        <%--</table>--%>
                        <%--&lt;%&ndash;<body>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<div id="paging"></div>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</body>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<div class="row text-center" id="list_info_wrapper">&ndash;%&gt;--%>
                        ...
                        <%--<div class="col-md-6">--%>
                            ...
                            <%--<div class="col-md-8">--%>
                                <%--<div class="input-file">--%>
                                    ...
                                    <%--&lt;%&ndash;<img src="/template2/assets/img/profile-avatar.png" alt="Profile Picture" style="height:150px;width: 150px">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<div id='View_area' style='position:relative; width: 150px; height: 150px; color: black; border: 0px solid black; dispaly: inline; '></div>&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<input type="file" name="profile_pt" id="profile_pt" onchange="previewImage(this,'View_area')">&ndash;%&gt;--%>
                                <%--</div>--%>
                            <%--</div>--%>
                        <%--</div>--%>
                        <%--<div class="col-md-6">--%>
                    ...
                    <%--<div class="col-md-12 no-padding">--%>
                        <%--<div class="col-md-6">--%>
                            ...
                            <%--<div class="col-md-8">--%>
                                ...
                                <%--&lt;%&ndash;<a class="btn btn-xs pull-right" id="bt_broadHistory" data-toggle="collapse" href="#detail" role="button" aria-expanded="false" aria-controls="detail">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;세부내역&ndash;%&gt;--%>
                                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                            <%--</div>--%>
                        <%--</div>--%>
