...
<%--<script>--%>
    <%--$(document).ready(function() {--%>
        ...
        <%--$('#bt_registMyStarList').click(function() {	    //   mystar--%>
            <%--getHistoryDetail("myStarHistory","MyStar 정보","ㆍMyStar 회원 리스트를 확인하고 등록/삭제할 수 있습니다.");--%>
        <%--});--%>
        <%--$('#bt_registMyFanlist').click(function() {		//   fan--%>
            <%--getHistoryDetail("myFanHistory","Fan 정보","ㆍFan으로 등록한 회원들의 리스트를 확인하고 등록/삭제할 수 있습니다.");--%>
        <%--});--%>
