                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 row">
                            ...
                            <label class="col-md-3 control-label">넥네임</label>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 row">
                            ...
                            <div class="col-md-9">
                                총 00건
                                <button type="button">세부내역</button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 row">
                            <div class="col-md-6 row">
                                ...
                                <div class="col-md-9 row">
                                    <label class="col-md-12 control-label">개인결제 정보</label>
                                </div>
                                <div class="col-md-3">
                                    <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <label class="col-md-12 control-label">현재 접속 플랫폼</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 row">
                            <div class="row">
                                <div class="col-md-3 row">
                                    <label class="col-md-12 control-label">공지</label>
                                </div>

                                <div class="col-md-9 row">
                                    <div class="row">
                                        <label class="col-md-6 control-label">개인공지</label>
                                        <div class="col-md-6">
                                            총 00건
                                            <button type="button">세부내역</button>
                                        </div>
                                    ...
                                    <div class="row">
                                        <label class="col-md-6 control-label">방송 중 공지</label>
                                        <div class="col-md-6">
                                            총 00건
                                            <button type="button">세부내역</button>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 row">
                                    <label class="col-md-12 control-label">신고/문의</label>
                                </div>

                                <div class="col-md-9 row">
                                    <div class="row">
                                        <label class="col-md-6 control-label">내가 신고한 정보</label>
                                        <div class="col-md-6">
                                            총 00건
                                            <button type="button">세부내역</button>
                                        </div>
                                    ...
                                    <div class="row">
                                        <label class="col-md-6 control-label">나를 신고한 정보</label>
                                        <div class="col-md-6">
                                            총 00건
                                            <button type="button">세부내역</button>
                                        </div>
                                    ...
                                    <div class="row">
                                        <label class="col-md-6 control-label">1:1 문의 정보</label>
                                        <div class="col-md-6">
                                            총 00건
                                            <button type="button">세부내역</button>
                                        </div>
