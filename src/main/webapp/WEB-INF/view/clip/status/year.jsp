    ...
    <div class="widget-content mt10">
        ...
        <div class="col-md-10 no-padding">
            ...
            <table class="table table-bordered _tableHeight" data-height="23px">
                ...
                <tbody id="ageYearListBody"></tbody>
            </table>
        </div>
...
<script type="text/javascript">
    ...
    function getYearList(){
        ...
        var data = dataSet();
        data.slctType = 2;
        util.getAjaxData("time", "/rest/clip/status/info/time", data, fn_year_success);

        // 선물 현황
        util.getAjaxData("clipStatusGift", "/rest/clip/status/gift", data, fn_clipStatusgiftYear_success);
        // 연령별
        util.getAjaxData("age", "/rest/clip/status/info/age", data, fn_clipStatusAgeYear_success);
        // 클립 주제별
        util.getAjaxData("type", "/rest/clip/status/info/type", data, fn_typeYear_success);
        // 플랫폼 별
        util.getAjaxData("platform", "/rest/clip/status/info/platform", data, fn_platformYearList_success);
    }
    ...
    function fn_clipStatusAgeYear_success(dst_id, response) {
        ...
        for(var i=0;i<response.data.detailList.length;i++){
            ...
            response.data.detailList[i].the_date = response.data.detailList[i].month;
            response.data.detailList[i].month = response.data.detailList[i].month.substr(5,2);
        }

        var template = $('#tmp_ageYearDetailList').html();
        var templateScript = Handlebars.compile(template);
        var detailContext = response.data.detailList;
        var html=templateScript(detailContext);
        $("#ageYearListBody").append(html);

        if(isDataEmpty){
            $("#ageYearListBody td:last").remove();
        }else{
            $("#ageYearListBody").append(totalHtml);
        }
    ...
    function fn_platformYearList_success(dst_id, response) {
        ...
        for(var i=0;i<response.data.detailList.length;i++){
            ...
            response.data.detailList[i].the_date = Number(moment().format("YYYY")) + "-" + response.data.detailList[i].the_date.substr(5,2);
...
<script type="text/x-handlebars-template" id="tmp_yearTotal">
    <tr class="font-bold _bgColor" data-bgColor="#d0cece">
        <td>총합</td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="2" data-searchSex="m" data-searchGroupBy="1" style="cursor:pointer;">{{addComma sum_maleCnt}}</span></td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-1" data-searchSex="m" style="cursor:pointer;">{{addComma sum_open_reg_maleCnt}}</span></td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-1" data-searchSex="m" style="cursor:pointer;">{{addComma sum_notopen_reg_maleCnt}}</span></td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-2" data-searchSex="m" style="cursor:pointer;">{{addComma sum_mem_del_maleCnt}}</span></td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-2" data-searchSex="m" style="cursor:pointer;">{{addComma sum_op_del_maleCnt}}</span></td>

        <td class="_fontColor" data-fontColor="red"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="2" data-searchSex="f" data-searchGroupBy="1" style="cursor:pointer;">{{addComma sum_femaleCnt}}</span></td>
        <td class="_fontColor" data-fontColor="red"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-1" data-searchSex="f" style="cursor:pointer;">{{addComma sum_open_reg_femaleCnt}}</span></td>
        <td class="_fontColor" data-fontColor="red"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-1" data-searchSex="f" style="cursor:pointer;">{{addComma sum_notopen_reg_femaleCnt}}</span></td>
        <td class="_fontColor" data-fontColor="red"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-2" data-searchSex="f" style="cursor:pointer;">{{addComma sum_mem_del_femaleCnt}}</span></td>
        <td class="_fontColor" data-fontColor="red"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-2" data-searchSex="f" style="cursor:pointer;">{{addComma sum_op_del_femaleCnt}}</span></td>

        <td class="_fontColor"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="2" data-searchSex="n" data-searchGroupBy="1" style="cursor:pointer;">{{addComma sum_noneCnt}}</span></td>
        <td class="_fontColor"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-1" data-searchSex="n" style="cursor:pointer;">{{addComma sum_open_reg_noneCnt}}</span></td>
        <td class="_fontColor"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-1" data-searchSex="n" style="cursor:pointer;">{{addComma sum_notopen_reg_noneCnt}}</span></td>
        <td class="_fontColor"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-2" data-searchSex="n" style="cursor:pointer;">{{addComma sum_mem_del_noneCnt}}</span></td>
        <td class="_fontColor"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="1-2" data-searchSex="n" style="cursor:pointer;">{{addComma sum_op_del_noneCnt}}</span></td>
...
<script type="text/x-handlebars-template" id="tmp_yearDetailList">
    ...
    <tr {{#dalbit_if nowMonth '==' month}} class="font-bold _bgColor" data-bgColor="#fff2cc"  {{/dalbit_if}}>
        ...
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="2" data-searchSex="m" data-searchGroupBy="1" style="cursor:pointer;">{{addComma maleCnt 'Y'}}</span></td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="1-1" data-searchSex="m" style="cursor:pointer;">{{addComma open_reg_maleCnt 'Y'}}</span></td>
...
<script type="text/x-handlebars-template" id="tmp_giftYear">
    <tr class="font-bold _bgColor" data-bgColor="#d0cece">
        <td>총합</td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="3" data-searchSex="m" style="cursor:pointer;">{{addComma sum_maleGiftCnt}}</span></td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="3" data-searchSex="m" style="cursor:pointer;">{{addComma sum_maleGiftAmount}}</span></td>
        <td class="_fontColor" data-fontColor="red"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="3" data-searchSex="f" style="cursor:pointer;">{{addComma sum_femaleGiftCnt}}</span></td>
        <td class="_fontColor" data-fontColor="red"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="3" data-searchSex="f" style="cursor:pointer;">{{addComma sum_femaleGiftAmount}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="3" data-searchSex="n" style="cursor:pointer;">{{addComma sum_noneGiftCnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="3" data-searchSex="n" style="cursor:pointer;">{{addComma sum_noneGiftAmount}}</span></td>
...
<script type="text/x-handlebars-template" id="tmp_giftYearDetailList">
    ...
    {{{the_date}}}
        ...
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="3" data-searchSex="m" style="cursor:pointer;">{{addComma maleGiftCnt 'Y'}}</span></td>
        <td class="_fontColor" data-fontColor="blue"><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="3" data-searchSex="m" style="cursor:pointer;">{{addComma maleGiftAmount 'Y'}}</span></td>
        <td class="_fontColor" data-fontColor="red"> <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="3" data-searchSex="f" style="cursor:pointer;">{{addComma femaleGiftCnt 'Y'}}</span></td>
        <td class="_fontColor" data-fontColor="red"> <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="3" data-searchSex="f" style="cursor:pointer;">{{addComma femaleGiftAmount 'Y'}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="3" data-searchSex="n" style="cursor:pointer;">{{addComma noneGiftCnt 'Y'}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="3" data-searchSex="n" style="cursor:pointer;">{{addComma noneGiftAmount 'Y'}}</span></td>
...
<script type="text/x-handlebars-template" id="tmp_ageYear">
    <tr class="font-bold _bgColor" data-bgColor="#d0cece">
        <td>총합</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="4-1" data-searchAgeType="1" style="cursor:pointer;">{{addComma sum_reg_12_16_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="4-2" data-searchAgeType="1" style="cursor:pointer;">{{addComma sum_del_12_16_cnt}}</span>)</td>
...
<script type="text/x-handlebars-template" id="tmp_ageYearDetailList">
    {{#each this as |data|}}
    <tr {{#dalbit_if nowMonth '==' month}} class="font-bold _bgColor" data-bgColor="#fff2cc"  {{/dalbit_if}}>
    <td {{#dalbit_if nowMonth '==' month}} class="font-bold _bgColor" data-bgColor="#fff2cc"  {{/dalbit_if}}
    {{#dalbit_if nowMonth '!=' month}} class="font-bold _bgColor" data-bgColor="#d8e2f3"  {{/dalbit_if}}>
    {{{the_date}}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-1" data-searchAgeType="1" style="cursor:pointer;">{{addComma reg_12_16_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-2" data-searchAgeType="1"  style="cursor:pointer;">{{addComma del_12_16_cnt}}</span>)
            {{else}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-1" data-searchAgeType="2" style="cursor:pointer;">{{addComma reg_17_19_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-2" data-searchAgeType="2"  style="cursor:pointer;">{{addComma del_17_19_cnt}}</span>)
            {{else}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-1" data-searchAgeType="3" style="cursor:pointer;">{{addComma reg_20_25_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-2" data-searchAgeType="3"  style="cursor:pointer;">{{addComma del_20_25_cnt}}</span>)
            {{else}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-1" data-searchAgeType="4" style="cursor:pointer;">{{addComma reg_26_30_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-2" data-searchAgeType="4"  style="cursor:pointer;">{{addComma del_26_30_cnt}}</span>)
            {{else}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-1" data-searchAgeType="5" style="cursor:pointer;">{{addComma reg_31_35_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-2" data-searchAgeType="5"  style="cursor:pointer;">{{addComma del_31_35_cnt}}</span>)
            {{else}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-1" data-searchAgeType="6" style="cursor:pointer;">{{addComma reg_36_40_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-2" data-searchAgeType="6"  style="cursor:pointer;">{{addComma del_36_40_cnt}}</span>)
            {{else}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-1" data-searchAgeType="7" style="cursor:pointer;">{{addComma reg_41_00_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-type="4-2" data-searchAgeType="7"  style="cursor:pointer;">{{addComma del_41_00_cnt}}</span>)
            {{else}}
...
<script type="text/x-handlebars-template" id="tmp_platformYear">
    <tr class="font-bold _bgColor" data-bgColor="#d0cece">
        <td>총합</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="7-1" data-searchOsType="3" style="cursor:pointer;">{{addComma sum_reg_pc_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-2" data-searchOsType="3" style="cursor:pointer;">{{addComma sum_del_pc_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="7-1" data-searchOsType="1" style="cursor:pointer;">{{addComma sum_reg_and_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-2" data-searchOsType="1" style="cursor:pointer;">{{addComma sum_del_and_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="7-1" data-searchOsType="2" style="cursor:pointer;">{{addComma sum_reg_ios_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-2" data-searchOsType="2" style="cursor:pointer;">{{addComma sum_del_ios_cnt}}</span>)</td>
        <td>{{addComma sum_reg_total_cnt}} ({{addComma sum_del_total_cnt}})</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="8" data-searchOsType="3" style="cursor:pointer;">{{addComma sum_listen_pc_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="8" data-searchOsType="1" style="cursor:pointer;">{{addComma sum_listen_and_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="8" data-searchOsType="2" style="cursor:pointer;">{{addComma sum_listen_ios_cnt}}</span></td>
...
<script type="text/x-handlebars-template" id="tmp_platformYearDetailList">
    ...
    <tr {{#dalbit_if nowMonth '==' month}} class="font-bold _bgColor" data-bgColor="#fff2cc"  {{/dalbit_if}}>
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-1" data-searchOsType="3" style="cursor:pointer;">{{addComma reg_pc_cnt }}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-2" data-searchOsType="3" style="cursor:pointer;">{{addComma del_pc_cnt }}</span>)
            {{else}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-1" data-searchOsType="1" style="cursor:pointer;">{{addComma reg_and_cnt }}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-2" data-searchOsType="1" style="cursor:pointer;">{{addComma del_and_cnt }}</span>)
            {{else}}
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-1" data-searchOsType="2" style="cursor:pointer;">{{addComma reg_ios_cnt }}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-2" data-searchOsType="2" style="cursor:pointer;">{{addComma del_ios_cnt }}</span>)
            {{else}}
        ...
        <td>
            {{#dalbit_if reg_total_cnt '!=' '0'}}
                <%--<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-1" style="cursor:pointer;">{{addComma reg_total_cnt }}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="7-2" style="cursor:pointer;">{{addComma del_total_cnt }}</span>)--%>
...
<script type="text/x-handlebars-template" id="tmp_typeYear">
    <tr class="font-bold _bgColor" data-bgColor="#d0cece">
        <td>총합</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="5-1" data-subjectType="01" style="cursor:pointer;">{{addComma sum_reg_01_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-sMonth="{{month}}" data-type="5-2" data-subjectType="01" style="cursor:pointer;">{{addComma sum_del_01_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="6" data-subjectType="01" style="cursor:pointer;">{{addComma sum_play_01_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="5-1" data-subjectType="02" style="cursor:pointer;">{{addComma sum_reg_02_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-sMonth="{{month}}" data-type="5-2" data-subjectType="02" style="cursor:pointer;">{{addComma sum_del_02_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="6" data-subjectType="02" style="cursor:pointer;">{{addComma sum_play_02_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="5-1" data-subjectType="03" style="cursor:pointer;">{{addComma sum_reg_03_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-sMonth="{{month}}" data-type="5-2" data-subjectType="03" style="cursor:pointer;">{{addComma sum_del_03_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="6" data-subjectType="03" style="cursor:pointer;">{{addComma sum_play_03_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="5-1" data-subjectType="04" style="cursor:pointer;">{{addComma sum_reg_04_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-sMonth="{{month}}" data-type="5-2" data-subjectType="04" style="cursor:pointer;">{{addComma sum_del_04_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="6" data-subjectType="04" style="cursor:pointer;">{{addComma sum_play_04_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="5-1" data-subjectType="05" style="cursor:pointer;">{{addComma sum_reg_05_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-sMonth="{{month}}" data-type="5-2" data-subjectType="05" style="cursor:pointer;">{{addComma sum_del_05_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="6" data-subjectType="05" style="cursor:pointer;">{{addComma sum_play_05_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="5-1" data-subjectType="06" style="cursor:pointer;">{{addComma sum_reg_06_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-sMonth="{{month}}" data-type="5-2" data-subjectType="06" style="cursor:pointer;">{{addComma sum_del_06_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="6" data-subjectType="06" style="cursor:pointer;">{{addComma sum_play_06_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="5-1" data-subjectType="07" style="cursor:pointer;">{{addComma sum_reg_07_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-sMonth="{{month}}" data-type="5-2" data-subjectType="07" style="cursor:pointer;">{{addComma sum_del_07_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="6" data-subjectType="07" style="cursor:pointer;">{{addComma sum_play_07_cnt}}</span></td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="5-1" data-subjectType="08" style="cursor:pointer;">{{addComma sum_reg_08_cnt}}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-sMonth="{{month}}" data-type="5-2" data-subjectType="08" style="cursor:pointer;">{{addComma sum_del_08_cnt}}</span>)</td>
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="3" data-type="6" data-subjectType="08" style="cursor:pointer;">{{addComma sum_play_08_cnt}}</span></td>
        <td>{{addComma sum_reg_total_cnt}} ({{addComma sum_del_total_cnt}})</td>
...
<script type="text/x-handlebars-template" id="tmp_typeYearDetailList">
    ...
    <tr {{#dalbit_if nowMonth '==' month}} class="font-bold _bgColor" data-bgColor="#fff2cc"  {{/dalbit_if}}>
        ...
        <td>
            ...
            <span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="5-1" data-subjectType="01" style="cursor:pointer;">{{addComma reg_01_cnt }}</span> (<span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="5-2" data-subjectType="01" style="cursor:pointer;">{{addComma del_01_cnt }}</span>)
            {{else}}
        ...
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="6" data-subjectType="01" style="cursor:pointer;">{{addComma play_01_cnt 'Y'}}</span></td>
        <td>
        ...
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="6" data-subjectType="02" style="cursor:pointer;">{{addComma play_02_cnt 'Y'}}</span></td>
        <td>
        ...
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="6" data-subjectType="03" style="cursor:pointer;">{{addComma play_03_cnt 'Y'}}</span></td>
        <td>
        ...
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="6" data-subjectType="04" style="cursor:pointer;">{{addComma play_04_cnt 'Y'}}</span></td>
        <td>
        ...
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="6" data-subjectType="05" style="cursor:pointer;">{{addComma play_05_cnt 'Y'}}</span></td>
        <td>
        ...
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="6" data-subjectType="06" style="cursor:pointer;">{{addComma play_06_cnt 'Y'}}</span></td>
        <td>
        ...
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="6" data-subjectType="07" style="cursor:pointer;">{{addComma play_07_cnt 'Y'}}</span></td>
        <td>
        ...
        <td><span onclick="resourceClipStatusClick($(this).data())" data-slctType="2" data-sMonth="{{month}}" data-type="6" data-subjectType="08" style="cursor:pointer;">{{addComma play_08_cnt 'Y'}}</span></td>
        <td>{{#dalbit_if reg_total_cnt '!=' '0'}}{{addComma reg_total_cnt }} ({{addComma del_total_cnt }}){{else}}{{#dalbit_if del_total_cnt '!=' '0'}}{{addComma reg_total_cnt }} ({{addComma del_total_cnt }}){{/dalbit_if}}{{/dalbit_if}}</td>
