...
<div class="widget widget-table mb10">
    <div class="widget-content mt10">
        <div class="col-md-11 no-padding" style="display: none;">
        ...
        <div class="col-md-8 no-padding">
            ...
            <table class="table table-bordered _tableHeight" data-height="23px">
                <colgroup>
                    <col width="7.9%"/><col width="11.5%"/><col width="11.5%"/><col width="11.5%"/><col width="11.5%"/>
                    <col width="11.5%"/><col width="11.5%"/><col width="11.5%"/>
                </colgroup>
                <thead>
                <tr>
                    <th rowspan="2" class="_bgColor" data-bgColor="#b4c7e7">구분</th>
