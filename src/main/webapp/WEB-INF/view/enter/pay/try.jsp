...
<%--<div class="widget widget-table mb10">--%>
    <%--<div class="widget-content mt10">--%>
        <%--&lt;%&ndash;<a href="javascript://" class="_prevSearch">[이전]</a>&ndash;%&gt;--%>
        <%--<span class="_searchDate"></span>--%>
        <%--&lt;%&ndash;<a href="javascript://" class="_nextSearch">[다음]</a>&ndash;%&gt;--%>
    ...
    <%--<div class="widget-footer">--%>
        <%--<span>--%>
            <%--&lt;%&ndash;<button class="btn btn-default print-btn pull-right" type="button" id="excelDownBtn"><i class="fa fa-print"></i>Excel Down</button>&ndash;%&gt;--%>
        <%--</span>--%>
    <%--</div>--%>
<%--</div>--%>
