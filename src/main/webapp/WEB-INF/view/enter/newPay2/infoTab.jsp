...
<%--                <div class="tab-pane fade" id="month"><jsp:include page="payMonth.jsp"/></div>          <!-- 월간결제 -->--%>
                ...
                <div class="tab-pane fade" id="member" style="width: 2000px"><jsp:include page="age.jsp"/></div>            <!-- 결제 회원별 -->
                <div class="tab-pane fade" id="way" style="width: 2000px"><jsp:include page="way.jsp"/></div>                  <!-- 결제 수단별 -->
