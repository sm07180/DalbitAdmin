                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="text-align: left">
                                        ...
                                        <span id="searchMemberArea" style="margin-top:2px; "
                                              onchange="btSearchClick();"></span>
                                        ...
                                        <label class="control-inline fancy-checkbox custom-color-green"
                                               id="exchangeCheckArea">
                                            <input type="checkbox" name="search_exchangeYn" id="search_exchangeYn"
                                                   value="1">
                    ...
                    <div class="col-lg-12 form-inline no-padding" id="topBotton">
                        <ul class="nav nav-tabs nav-tabs-custom-colored" role="tablist">
                            ...
                            <li class="_tab active">
                                <a href="#recommend" id="tab_specialDj" name="tab_specialDj" role="tab"
                                   data-toggle="tab" data-specialDj="1">스페셜DJ</a>
                            </li>
                            <li class="_tab">
                            ...
                            <li class="_tab">
                                <a href="#recommend" id="tab_user" name="tab_user" role="tab" data-toggle="tab"
                                   data-specialDj="0">일반회원</a>
                            </li>

                            <c:if test="${fn:contains('|이재은|이형원|전유신|강다인|고병권|이재호|양효진|최계석|손우걸|', principal.getUserInfo().getName())}">
                                <li class="_tab ml15">
                                    <a href="javascript://" id="rejectList" name="rejectList" role="tab"
                                       data-toggle="tab">취소내역</a>
                                </li>
                            </c:if>

                            <li class="_tab">
                                <a href="javascript://" id="enableList" name="enableList" role="tab" data-toggle="tab">환전신청
                                    가능회원</a>
                            </li>
                        </ul>
                            ...
                            <div class="col-lg-12 no-padding" style="margin-left: 0px">
                                ...
                                <div class="col-md-12 no-padding">
                                    <div class="col-md-2 no-padding pull-right" id="div_testIdTable">
                                        <table class="table table-sorting table-hover table-bordered mt5"
                                    ...
                                    <div class="col-md-12 no-padding">
                                        <div class="dataTables_paginate paging_full_numbers mt15"
                                             id="list_info_paginate_top"></div>
                                        <div class="col-lg-12 no-padding" id="listTable"></div>
                                        <div class="dataTables_paginate paging_full_numbers"
                                             id="list_info_paginate"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="exchangeDetailModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
...
<script type="text/javascript">
  ...
  $(document).on('click', '#excelDownBtn', function () {
    ...
    hiddenData += hidden.replace('{name}', 'djType').replace('{value}', getParameter().djType); // 2: 플레이메이커
        ...
        <div class="col-md-12 no-padding">
            ...
            <div class="col-md-6 mt10">
                ...
                <div class="pull-right">
                    ...
                    <br/>
                    <br/>
                    <button class="btn btn-sm btn-success print-btn ml5 mr5 no-margin" type="button" id="excelDownBtn">
                        <i class="fa fa-print"></i> Excel Down
                    </button>
                    <button class="btn btn-sm btn-primary print-btn ml5 mr5 no-margin" type="button" id="completeBtn"><i
                            class="fa fa-check-square"></i> 선택 완료처리
                    </button>
                    <button class="btn btn-sm btn-success print-btn" type="button" id="completeListBtn"><i
                            class="fa fa-print"></i>완료내역 받기
                    </button>
                    ...
                    <button class="btn btn-sm btn-success print-btn" type="button" id="completeExcelDownBtn"
                            style="display:none;"><i class="fa fa-print"></i>Down
                    </button>
                </div>
            </div>
        </div>
...
<script type="text/x-handlebars-template" id="tmp_exchangeList">
    ...
    <td><a href="javascript://" class="_openMemberPop" data-memno="{{data.mem_no}}">{{data.mem_no}}</a><br/>{{data.mem_nick}}
    </td>
    ...
    <td>{{#dalbit_if data.last_reg_date '!=' ''}}{{convertToDate data.last_reg_date 'YYYY-MM-DD
        HH:mm:ss'}}{{/dalbit_if}}
    </td>
...
<script type="text/x-handlebars-template" id="tmp_layer_detail">
    <form id="exchangeForm">
        ...
        <div class="modal-dialog"
             style="{{#if parentInfo.parents_name}}{{/if}}width:900px; {{^if parentInfo.parents_name}}width:750px{{/if}}">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="{{#if parentInfo.parents_name}}col-lg-8{{/if}}{{^if parentInfo.parents_name}}col-lg-12{{/if}}">
                            ...
                            <table id="list_info" class="table table-sorting table-hover table-bordered">
                                ...
                                <tr>
                                    <th>
                                        접수서류<br/>
                                        <button type="button" class="btn btn-success btn-xm" onclick="imageUpload();">
                                            저장완료
                                        </button>
                                    </th>
                                    <td colspan="3">
                                        <div class="col-lg-4" style="border:solid 1px black">
                                            <a href="javascript://">
                                                <img class="_fullWidth _openImagePop thumbnail"
                                                     src="{{renderImage detail.add_file1}}"
                                                     style="width:170px;height:116px;"/>
                                            </a>
                                        ...
                                        <div class="col-lg-4" style="border:solid 1px black">
                                            <a href="javascript://">
                                                <img class="_fullWidth _openImagePop thumbnail"
                                                     src="{{renderImage detail.add_file2}}"
                                                     style="width:170px;height:116px;"/>
                                            </a>
                                        ...
                                        <div class="col-lg-4" style="border:solid 1px black">
                                            <a href="javascript://">
                                                <img class="_fullWidth _openImagePop thumbnail"
                                                     src="{{renderImage detail.add_file3}}"
                                                     style="width:170px;height:116px;"/>
                                            </a>
                                            <input id="files3" type="file" onchange="photoSubmit($(this))"/>
                                            <input type="hidden" class="_hidden_filename" name="add_file3"
                                                   id="add_file3" value="{{detail.add_file3}}"/>
                                        </div>
                                    </td>
                                </tr>
...
<script type="text/x-handlebars-template" id="tmp_enableSummary">
    <div class="col-lg-12 no-padding" style="height: 75px;">
        <table class="table table-bordered table-summary pull-right no-margin _tableHeight" data-height="24"
            ...
            <tr>
                <th colspan="5" class="_bgColor _fontColor" data-bgcolor="black" data-fontcolor="white">환전 신청 가능 (570별)
                    이상 회원 중
                </th>
            </tr>
            <tr>
...
<script type="text/x-handlebars-template" id="tmp_enableList">
    ...
    <td><a href="javascript://" class="_openMemberPop" data-memno="{{data.mem_no}}">{{data.mem_no}}</a> <br/>
        {{data.mem_nick}}
    </td>
    ...
    <td>
        ...
        <a href="javascript://" class="_openMemberPop" data-memno="{{data.mem_no}}" data-tabid="tab_exchangeDetail">{{addComma
            data.exchangeCnt}}번</a>
        {{else}}
