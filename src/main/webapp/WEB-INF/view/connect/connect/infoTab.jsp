        ...
        <div class="row col-lg-12 form-inline" style="padding-top: 2px; padding-bottom: 0px;">
            <div class="widget-content">
                <ul class="nav nav-tabs nav-tabs-custom-colored" role="tablist" id="tablist_con">
                    ...
                    <li><a href="#visitor" role="tab" data-toggle="tab" id="tab_visitorDetail">방문자 분석</a></li>
                    <li><a href="#user" role="tab" data-toggle="tab" id="tab_userDetail">접속자 분석</a></li>
                    <li><a href="#pageView" role="tab" data-toggle="tab" id="tab_pageViewDetail">페이지 뷰</a></li>
                </ul>
