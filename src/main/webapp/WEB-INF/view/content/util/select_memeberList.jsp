...
<script>
    ...
    var targetId = "select_memeberList";
    ...
    $(document).ready(function () {
        ...
        $("#"+targetId).find("#searchType").html(util.getCommonCodeSelect(-1, searchType));
    });

    var callbackFn;
    function showPopMemberList(fn) {
        callbackFn = fn;
        $("#"+targetId).find("#modal_select_memebet").modal("show");
    }
