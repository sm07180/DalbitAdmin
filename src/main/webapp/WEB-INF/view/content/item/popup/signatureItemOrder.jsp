    ...
    <div id="page-wrapper">
        <div class="widget-content mt15">
            <ul class="nav nav-tabs nav-tabs-custom-colored" role="tablist" id="tablist_con">
                <li class="active"><a href="#text" role="tab" data-toggle="tab" id="" onclick="giftList(5);">시그니처</a></li>
            </ul>
...
<script>
  <%--var memNo = "<%=in_memNo%>";--%>
  <% String sgnt_mem_no = (String)request.getAttribute("sgnt_mem_no"); %>
  const sgnt_mem_no = <%= sgnt_mem_no %> ;
