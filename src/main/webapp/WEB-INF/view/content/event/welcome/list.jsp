    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="clearfix widget-content mt5 mb5">
                ...
                <div class="mb15">
                    <div id="welcome-toggle" style="float: right;"></div>
                    <div class="clearfix"></div>
                </div>

                <div id="slct_tabContainer" class="mb15">
                    <ul class="nav nav-tabs nav-tabs-custom-colored" id="kkanbu_tablist">
                        <li class="active"><a href="#detail_event" role="tab" data-toggle="tab" data-slct_type="0"
                                              aria-expanded="false" class="_tab">청취자</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-slct_type="1"
                               aria-expanded="false" class="_tab">DJ</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-slct_type="2"
                               aria-expanded="false" class="_tab">관리</a></li>
                    </ul>
                </div>

                <div id="section_tabContainer" class="mb15">
                    <ul class="nav nav-tabs nav-tabs-custom-colored" id="section_tablist">
                        <li class="active"><a href="#detail_event" role="tab" data-toggle="tab" data-section_no="0"
                                              aria-expanded="false" class="_tab">전체</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-section_no="1"
                               aria-expanded="false" class="_tab">1단계</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-section_no="2"
                               aria-expanded="false" class="_tab">2단계</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-section_no="3"
                               aria-expanded="false" class="_tab">3단계</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-section_no="4"
                               aria-expanded="false" class="_tab">ALL CLEAR</a></li>
                    </ul>
                </div>

                <div id="gift_admin_tabContainer" class="mb15 hidden">
                    <ul class="nav nav-tabs nav-tabs-custom-colored" id="gift_admin_tablist">
                        <li class="active"><a href="#detail_event" role="tab" data-toggle="tab" data-gift_admin_no="0"
                                              aria-expanded="false" class="_tab">청취자</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-gift_admin_no="1"
                               aria-expanded="false" class="_tab">DJ</a></li>
                    </ul>
                </div>
                ...
                <div id="gift_admin_goal_tabContainer" class="mb15 hidden">
                    <ul class="nav nav-tabs nav-tabs-custom-colored" id="gift_admin_goal_tablist">
                        <li class="active"><a href="#detail_event" role="tab" data-toggle="tab"
                                              data-gift_admin_goal_no="1" aria-expanded="false" class="_tab">1단계</a>
                        </li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-gift_admin_goal_no="2"
                               aria-expanded="false" class="_tab">2단계</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-gift_admin_goal_no="3"
                               aria-expanded="false" class="_tab">3단계</a></li>
                    </ul>
                ...
                <div id="gift_admin_section_tabContainer" class="mb15 hidden">
                    <ul class="nav nav-tabs nav-tabs-custom-colored" id="gift_admin_section_tablist">
                        <li class="active"><a href="#detail_event" role="tab" data-toggle="tab"
                                              data-gift_admin_section_no="1" aria-expanded="false" class="_tab">1단계</a>
                        </li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-gift_admin_section_no="2"
                               aria-expanded="false" class="_tab">2단계</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-gift_admin_section_no="3"
                               aria-expanded="false" class="_tab">3단계</a></li>
                        <li><a href="#detail_event" role="tab" data-toggle="tab" data-gift_admin_section_no="4"
                               aria-expanded="false" class="_tab">ALL CLEAR</a></li>
                    </ul>
...
<script type="text/javascript">
  ...
  const welcomeEventData = (function () {
    ...
    // 이벤트 ON/OFF
    function getSetting() {
      $('#welcome-toggle').empty();
      let apiURL = '/rest/content/event/welcome/setting';
      util.getAjaxData("getSetting", apiURL, {}, function (id, response, params) {
        renderSetting(id, response, params);
      }, null, {type: 'GET'});
    }

    function renderSetting(id, response, params) {
      let template, templateScript, context, html;
      template = $('#tmp_welcome_setting').html();
      templateScript = Handlebars.compile(template);
      response.welcomeSetOn = (response.welcomeSet === 'y') ? 1 : 0;
      context = response;
      html = templateScript(context);
      $("#welcome-toggle").html(html);
    }

    function modifySetting(welcomeSet) {
      let apiURL = '/rest/content/event/welcome/setting';
      util.getAjaxData("modifySetting", apiURL, {setSlct: welcomeSet}, function (id, response, params) {
        getSetting();
      }, null, {type: 'POST'});
    }
  ...
  $(function () {
    ...
    // 방송방 플로팅 노출여부 토글
    $(document).on('click', '#detail_welcomeSetOn', function() {
      let $this = $(this);
      let welcomeSet = $this.is(':checked') ? 'y' : 'n';
      welcomeEventData.modifySetting(welcomeSet);
    });
  });
</script>

<script type="text/x-handlebars-template" id="tmp_welcome_setting">
    <table class="table table-sorting table-hover table-bordered mb0" style="width: 300px">
        <colgroup>
            <col width="200px">
            <col width="auto">
        </colgroup>
        ...
        <tr>
            <td>방송방 플로팅 노출여부</td>
            <td>
                {{{getOnOffSwitch welcomeSetOn 'welcomeSetOn'}}}
            </td>
        </tr>
        </tbody>
    </table>
            ...
            <tr>
                ...
                <td class="text-left">
                    <div class="form-inline">
                        <input type="text" name="qualifyVal" class="form-control" style="width: 60px"
                               value="{{qualifyVal}}">
    ...
    <form name="formGiftAdmin" id="formGiftAdmin">
        <table class="table table-sorting table-hover table-bordered mb0" style="width: 900px">
            ...
            <tr class="giftAdminRows">
                ...
                <td class="text-left">
                    <div class="form-inline">
                        <input type="text" name="giftDalCnt" class="form-control" style="width: 60px"
                               value="{{giftDalCnt}}">
                        건
                    </div>
                </td>
    ...
    <table id="step_table" class="table table-sorting table-hover table-bordered">
        ...
        <tr>
            ...
            <td class="gift-td">
                ...
                <input type="checkbox" class="gift-checkbox" data-memno="{{mem_no}}" data-code="{{mem_gift_code}}"
                       data-name="{{mem_gift_name}}">
                {{/dalbit_if}}
                {{/dalbit_if}}
                {{#dalbit_if slctType '==' 'dj'}}
                {{#dalbit_if dj_gift_rcv_yn '==' 'y'}} O {{/dalbit_if}}
                {{#dalbit_if dj_gift_rcv_yn '==' 'n'}}
                <input type="checkbox" class="gift-checkbox" data-memno="{{mem_no}}" data-code="{{dj_gift_code}}"
                       data-name="{{dj_gift_name}}">
                {{/dalbit_if}}
                {{/dalbit_if}}
            </td>
        </tr>
