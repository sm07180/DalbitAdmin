...
<button class="btn btn-default btn-sm print-btn pull-right excelDownBtn_byeol" type="button"><i class="fa fa-print"></i>Excel Down</button>
...
<script type="text/javascript">
    ...
    $('.excelDownBtn_byeol').on('click', function(){
