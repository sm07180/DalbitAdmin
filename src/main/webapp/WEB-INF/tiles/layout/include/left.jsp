            ...
            <ul class="main-menu">
                ...
                <li class="${fn:contains(url, '/customer/faq/list') ? 'active': ''}">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-caret-square-o-down"></i><span class="text">앱다운로드</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-cloud-download"></i></i><span class="text">접속현황</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-user"></i><span class="text">회원현황</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-microphone"></i><span class="text">방송현황</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-headphones"></i><span class="text">캐스트현황</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-krw"></i><span class="text">결제/환전</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-times"></i><span class="text">결제취소/환전</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-suitcase"></i><span class="text">상품</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                        ...
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-spinner"></i><span class="text">장애분석</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-gift"></i><span class="text">이벤트</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript://">
                                <i class="fa fa-users"></i><span class="text">파트너 DJ</span>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="sub-menu" style="${fn:startsWith(url, '/exchange/') ? 'display:block;': ''}">
                        <li class="${fn:contains(url, '/exchange/exchange/list') ? 'active': ''}">
                            <a href="/exchange/exchange/list">
                                <i class="fa fa-krw"></i><span class="text">환전신청/처리</span>
                            </a>
                        </li>
                    ...
                    <ul class="sub-menu" style="${fn:startsWith(url, '/menu/') ? 'display:block;': ''}">
                        <li class="${fn:contains(url, '/menu/recommend/list') ? 'active': ''}">
                            <a href="/menu/recommend/list">
                                <i class="fa fa-thumbs-o-up"></i><span class="text">추천DJ</span>
                            </a>
                        </li>
                        <li class="${fn:contains(url, '/menu/best/list') ? 'active': ''}">
                            <a href="/menu/best/list">
                                <i class="fa fa-star"></i><span class="text">인기DJ</span>
                            </a>
                        </li>
                        ...
                        <li class="${fn:contains(url, '/menu/cast/list') ? 'active': ''}">
                            <a href="/menu/cast/list">
                                <i class="fa fa-headphones"></i><span class="text">캐스트</span>
                            </a>
                        </li>
                    </ul>
                </li>
